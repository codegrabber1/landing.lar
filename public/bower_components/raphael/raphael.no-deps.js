...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * Find dot coordinates on the given cubic bezier curve at the given t.
     ...
     o     }
     o     landing: {
     o         x: (number) x coordinate of the landing of the curve
     o         y: (number) y coordinate of the landing of the curve
     o     }
     o     end: {
     ...
     * Adds event handlers for drag of the element.
     ...
     - onstart (function) handler for drag landing
     - onend (function) handler for drag end
     - mcontext (object) #optional context for moving handler
     - scontext (object) #optional context for drag landing handler
     - econtext (object) #optional context for drag end handler
     * Additionally following `drag` events will be triggered: `drag.landing.<id>` on landing,
     * `drag.end.<id>` on end and `drag.move.<id>` on every move. When element will be dragged over another element
     * `drag.over.<id>` will be fired as well.
     *
     * Start event and landing handler will be called in specified context or in context of the element with following parameters:
     o x (number) x position of the mouse
     o y (number) y position of the mouse
     o event (object) DOM event object
     * Move event and move handler will be called in specified context or in context of the element with following parameters:
     o dx (number) shift by x from the landing point
     o dy (number) shift by y from the landing point
     o x (number) x position of the mouse
     o y (number) y position of the mouse
     o event (object) DOM event object
     ...
     **
     - path (string) SVG path string
     - from (number) position of the landing of the segment
     ...
     **
     > Parameters
     **
     - delay (number) number of ms to pass between animation landing and actual animation
     **
     ...
     *
     * On each animation frame event `anim.frame.<id>`, on landing `anim.landing.<id>` and on end `anim.finish.<id>`.
    \*/
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     * or
     ...
     o text-anchor (string) [“`landing`”, “`middle`”, “`end`”], default is “`middle`”
